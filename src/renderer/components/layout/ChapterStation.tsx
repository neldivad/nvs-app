  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="flex w-5 flex-col items-center">
        <span className={cn('mt-0.5 text-[11px] leading-none', TONE[kind])} title={kind === 'quiet' ? 'no activity this chapter' : kind === 'terminal' ? 'closes here' : undefined}>{GLYPH[kind]}</span>
      ...
      <div className="min-w-0 flex-1 pb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {kind === 'terminal' && <span className="shrink-0 text-[9px] uppercase tracking-wide text-faint">terminus</span>}
